...
!SMS$IGNORE BEGIN
        ...
        IF ( IOST_RD /= 0 ) THEN
          WRITE(UNIT=*, FMT=*) "READ NAMELIST 'IPEDIMS' FAILED!", IOST_RD
          WRITE(*,NML=IPEDIMS ) 
          STOP
        ENDIF
        ...
        IF ( IOST_RD /= 0 ) THEN
          WRITE(UNIT=*, FMT=*) "READ NAMELIST 'NMIPE' FAILED!", IOST_RD
          WRITE(*,NML=NMIPE ) 
          STOP
        ENDIF
!SMS$IGNORE END
...
!SMS$SERIAL BEGIN
        ...
        IF ( IOST_RD /= 0 ) THEN
          WRITE(UNIT=*, FMT=*) "READ NAMELIST 'NMFLIP' FAILED!", IOST_RD
          WRITE(*,NML=NMFLIP ) 
          STOP
        ENDIF
        ...
        IF ( IOST_RD /= 0 ) THEN
          WRITE(UNIT=*, FMT=*) "READ NAMELIST 'NMMSIS' FAILED!", IOST_RD
          WRITE(*,NML=NMMSIS ) 
          STOP
        ENDIF
        ...
        IF ( IOST_RD /= 0 ) THEN
          WRITE(UNIT=*, FMT=*) "READ NAMELIST 'NMSWITCH' FAILED!", IOST_RD
          WRITE(*,NML=NMSWITCH ) 
          STOP
        ENDIF
